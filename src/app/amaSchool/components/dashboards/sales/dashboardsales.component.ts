        ...
        this.timelineEvents = [
            {
                ...
                color: '#E91E63',
                description:
                    'Richard Jones (C8012) has ordered a blue t-shirt for $79.',
            },
            {
                status: 'Processing',
            ...
            },
            {
                ...
                color: '#673AB7',
                description:
                    'Order #99207 has shipped with shipping code 2222302090.',
            },
            {
                status: 'Delivered',
                ...
                color: '#0097A7',
                description:
                    'Richard Jones (C8012) has recieved his blue t-shirt.',
            },
        ];
    }
